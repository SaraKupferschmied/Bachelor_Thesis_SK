...
class LanguagesOfStudySpider(scrapy.Spider):
    """
    Crawl the University of Fribourg "Languages of study" page and
    export only the main content area, including accordion content that is
    already present in the static HTML.

    Example:
        scrapy crawl languages_of_study -O spider_outputs/languages_of_study.json
    """

    name = "languages_of_study"
    allowed_domains = ["www.unifr.ch"]
    start_urls = [
        "https://www.unifr.ch/studies/en/organisation/beginning-of-studies/languages-of-study.html"
    ]
    ...
    page_heading_expected = "Languages of study"
    doc_key = "unifr_languages_of_study_en"
