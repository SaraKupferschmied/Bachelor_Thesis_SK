...
class UnifrEliteSportsSpider(scrapy.Spider):
    """
    Crawl one UNIFR support topic separately.

    Run:
        scrapy crawl unifr_elite_sports -O spider_outputs/unifr_elite_sports.json
    """

    name = "unifr_elite_sports"
    allowed_domains = ["www.unifr.ch", "unifr.ch"]
    start_urls = ["https://www.unifr.ch/studies/en/organisation/during-studies/studies-and-elite-sportswomen-and-sportsmen.html"]
    ...
    TOPIC = "studies_and_elite_sport"
    SOURCE_TYPE = "unifr_elite_sport_page"
    DOC_KEY_PREFIX = "unifr_elite_sport"
    MAX_RECURSIVE_DEPTH = 1

    RELEVANT_LINK_KEYWORDS = {'athlete', 'sports', 'contact', 'studies', 'support', 'exam', 'accommodation', 'study', 'sportsmen', 'request', 'form', 'sport', 'sportswomen', 'elite'}
