...
class UnifrStudiesDisabilitySpider(scrapy.Spider):
    """
    Crawl one UNIFR support topic separately.

    Run:
        scrapy crawl unifr_studies_disability -O spider_outputs/unifr_studies_disability.json
    """

    name = "unifr_studies_disability"
    allowed_domains = ["www.unifr.ch", "unifr.ch"]
    start_urls = ["https://www.unifr.ch/campus/en/support/learning-and-success/studies-and-disability.html"]
    ...
    TOPIC = "studies_and_disability"
    SOURCE_TYPE = "unifr_studies_disability_page"
    DOC_KEY_PREFIX = "unifr_studies_disability"
    MAX_RECURSIVE_DEPTH = 1

    RELEVANT_LINK_KEYWORDS = {'support', 'handicap', 'contact', 'success', 'learning', 'exam', 'accommodation', 'needs', 'disability', 'special', 'request', 'form', 'adaptation'}
